 ...
 */
  ...
  openform(BuildContext context, String url,String strTitle,String strData,int nOpenMode,int nAnimation){
     String strOrginUrl=url;
     String strUrl=ZRConstants.zipPath+url;
     
       Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return ZiRuWebForm(strOrginUrl,strUrl,strTitle,strData,nOpenMode,nAnimation,this);
                  }));
  }
}
